...
<h2 style='color: #000000 !important; margin-bottom: 15px; text-shadow: none;'>AI Layer</h2>
<div style='background: rgba(46, 204, 113, 0.4); padding: 8px; border-radius: 8px; margin-bottom: 8px; color: #000000; font-weight: 700;'>Groq LLM</div>
<div style='background: rgba(46, 204, 113, 0.4); padding: 8px; border-radius: 8px; margin-bottom: 8px; color: #000000; font-weight: 700;'>HuggingFace</div>
<div style='background: rgba(46, 204, 113, 0.4); padding: 8px; border-radius: 8px; color: #000000; font-weight: 700;'>Embeddings</div>
</div>
<!-- Database Card -->
